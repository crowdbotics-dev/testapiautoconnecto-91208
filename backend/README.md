...
## Project Structure
    ...
    ├── testapiautoconnecto_91208  # Django project configurations
...
1. Clone this repo and `cd testapiautoconnecto_91208`
...
2. Clone this repo and `cd testapiautoconnecto_91208`
